...
const SpeakingImagePage: React.FC<AudioRecorderProps> = ({ onRecord, onStop }) => {
    ...
    return (
        ...
        >
             <div className="flex justify-center items-center space-x-2"> 
                ...
                <h1 style={{ color: getColor("my-purple-900") }} className="text-center text-2xl font-bold"> {requestGET.text}</h1>
                <h2 style={{ color: getColor("my-purple-500") }} className="text-center text-xl"> {requestGET.textTraslation}</h2>
