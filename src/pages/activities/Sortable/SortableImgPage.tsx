...
const INITIAL_DATA = {
  ...
  imgs: [
    { id: 0, url: "../img/apple.png" },
    { id: 1, url: "../img/biscocho.jpg" },
    { id: 0, url: "../img/buzo.jpg" },
    { id: 2, url: "../img/telefono.jpg" },

    { id: 0, url: "../img/naranja.jpg" },
    { id: 2, url: "../img/compu.jpg" },
    { id: 1, url: "../img/pantalon.jpg" },
    { id: 1, url: "../img/biscocho2.jpg" },
  ],
};
